...
import useraccount from '../../public/user-account.svg'
...
const Layout = ({ children }: LayoutProps) => {
    return (
        <div>
            ...
            <div className="w-500px rounded-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 width-5 height-5 m-5 p-5 ... ">
          <img
            alt="logo"
            src="logo.webp" />
        </div>
...
{/* input search */}
  <div className="flex gap-2">
    <div className="form-control">
      <input type="search" placeholder="Search anything" className="input input-bordered w-24 md:w-auto justify-center" />
    </div>
