...
{/* viewers and likes */}
    ...
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      ...
      <a href="#slide2" className="btn btn-circle">❯</a>
        ...
        <div className="flex justify-between gap-5" id="slide2">
            <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 width-10 height-5 m-5 p-5 ... ">
                <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template/w_394,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1678454437383-aa4984.jpeg"></img>
                
            </div>

            <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 width-5 height-5 m-5 p-5 ... ">
                <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template/w_394,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1678463309015-2b92d2.jpeg"></img>
            
            </div>

            <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 width-5 height-5 m-5 p-5 ... ">
                <img src="https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template/w_394,dpr_1,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1723117999918-053994.jpeg"></img>
          </div>
            <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
  ...
  <div id="slides1" className="carousel-item relative w-full">
    <img
      src="https://img.daisyui.com/images/stock/photo-1625726411847-8cbb60cc71e6.webp"
      className="w-50" />
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slides4" className="btn btn-circle">❮</a>
      <a href="#slides2" className="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slides2" className="carousel-item relative w-full">
    <img
      src="https://img.daisyui.com/images/stock/photo-1609621838510-5ad474b7d25d.webp"
      className="w-full" />
    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
      <a href="#slides1" className="btn btn-circle">❮</a>
      <a href="#slides3" className="btn btn-circle">❯</a>
    </div>
  </div>
  <div id="slides3" className="carousel-item relative w-full">
    <img
  ...
  <div id="slides4" className="carousel-item relative w-full">
    <img
